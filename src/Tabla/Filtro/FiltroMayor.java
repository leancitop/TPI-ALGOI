...
/**
 * La clase FiltroMayor extiende Filtro y proporciona una implementación para
 * filtrar filas de una columna que contienen valores numéricos mayores que un valor dado.
 */
public class FiltroMayor extends Filtro {

    /**
     * Constructor por defecto para la clase FiltroMayor.
     */
    public FiltroMayor() {
    }

    /**
     * Filtra las filas de una columna que contienen valores numéricos mayores que un valor dado.
     * 
     * @param columna La columna sobre la cual se realizará el filtrado.
     * @param valor El valor de comparación como String.
     * @return Una lista de índices de las filas que contienen valores numéricos mayores que el valor dado.
